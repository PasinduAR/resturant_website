          ...
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm">
                ...
                itaque minima fuga quis a neque eius quam, voluptatum aut
                possimus?
              </p>
              <div>
                <button
            ...
            >
              ...
              >
                <img
                  ...
                  src={imageId}
                  alt=""
                  className="w-[300px] sm:w-[450px] ms-auto spin"
                />
              </div>
              {/* image list section */}
              <div
                className="flex lg:flex lg:flex-col lg:top-1/2
              ...
              >
                {ImageList.map((item) => (
                  ...
                  object-contain inline-block hover:scale-105
                  duration-200"
                    onClick={() => {
                      setImageId(
